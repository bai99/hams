...
if($cid!="")
{
$r="select * from am_book where ambook_id =".$cid."";
$rex=mysql_db_query("hamsone",$r);
$ambook_id=mysql_result($rex,0,"ambook_id");
$uname=mysql_result($rex,0,"uname");

//$pic=mysql_result($rex,0,"pic");
}
if(isset($_POST["btnsave"]))
{
$u="update am_book set 
uname='".$_POST["uname"]."'
where ambook_id=".$cid."";
$rs=mysql_db_query("hamsone",$u);
...
<p><a href="ambulance-invoice.php"><button name="btnsave">UPDATE</button></a></p>
